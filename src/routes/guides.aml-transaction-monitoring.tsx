...
export const Route = createFileRoute("/guides/aml-transaction-monitoring")({
  head: () => ({
    meta: [
      ...
      {
        property: "og:url",
        content: "https://saphinpraja.com.np/guides/aml-transaction-monitoring",
      },
    ...
    links: [
      {
        rel: "canonical",
        href: "https://saphinpraja.com.np/guides/aml-transaction-monitoring",
      },
    ],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          description:
            "A practical guide to building a basic AML transaction monitoring script with Python and SQL — rules, thresholds, and alerting.",
          url: "https://saphinpraja.com.np/guides/aml-transaction-monitoring",
          mainEntityOfPage: "https://saphinpraja.com.np/guides/aml-transaction-monitoring",
        }),
      },
    ],
  }),
